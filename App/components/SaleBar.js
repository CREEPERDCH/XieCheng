        ...
        return (
            <View style={styles.container}>
                <TitleBar
                    ...
                    right_text={benefitData.description}/>
    ...
    renderLeft(benefitItem) {
        return (
            <View style={styles.left}>
                <View>
                    <Image style={styles.left_img} source={{uri: benefitItem.imageUrl}}/>
                </View>
                <Text style={styles.left_text} numberOfLines={2}>
                    {benefitItem.title}.{benefitItem.description}
                </Text>
